...
export const NewsCard = ({ newsImage, newsDate, newsTitle }) => {
  return (
    <div className="2xl:w-[589px] 2xl:h-[700px] lg:w-[440px] lg:h-[540px] md:h-[320px] md:w-[240px]  h-[200px] w-[156px] flex flex-col items-center justify-between cursor-pointer">
      <div className="2xl:w-[589px] 2xl:h-[589px] lg:w-[440px] lg:h-[440px] md:h-[240px] md:w-[240px] h-[156px] w-[156px] rounded-xl cursor-pointer overflow-hidden">
