...
export const NewsCard = ({ newsImage, newsDate, newsTitle }) => {
  return (
    <div className="2xl:w-[589px] 2xl:h-[700px] w-[455px] h-[570px] flex flex-col items-center justify-between ">
      <div className="2xl:w-[589px] 2xl:h-[589px] w-[455px] h-[455px] rounded-xl cursor-pointer overflow-hidden">
      ...
      <div className="flex flex-col items-start gap-2">
        <h6 className="text-xl font-thin text-[#000000]">{newsDate}</h6>
